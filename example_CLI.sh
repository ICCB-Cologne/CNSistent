...
cns segment dummy --select bands --out ./tests/out/test_segs_bands.bed --verbose
cns segment dummy --split 1000000 --out ./tests/out/test_segs_1MB.bed --verbose
cns segment dummy --split 1000000 --out ./tests/out/test_segs_1MB_gaps.bed --remove gaps --filter 500000 --verbose
cns segment dummy --select arms --out ./tests/out/test_segs_arms_gaps.bed --remove gaps --filter 100000
