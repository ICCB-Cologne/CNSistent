...
cns segment ./tests/out/test_cns_fill.tsv --select arms --out ./tests/out/test_segs_arms.bed --verbose
cns segment ./tests/out/test_cns_fill.tsv --select bands --out ./tests/out/test_segs_bands.bed --verbose
...
cns segment ./tests/out/test_cns_fill.tsv --select arms --out ./tests/out/test_segs_arms_gaps.bed --remove gaps --filter 100000
cns segment ./tests/out/test_cns_fill.tsv --select ./data/COSMIC_consensus_genes.bed --out ./tests/out/test_COSMIC_gaps.bed --remove gaps --filter 100000
