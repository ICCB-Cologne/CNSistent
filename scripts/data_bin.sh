...
do    
    ...
    # cns bin $bin_shared_args --out "${out}/${dataset}_bin_10MB.tsv" --bins 10000000 --remove gaps --filter 1000000# cns bin $bin_shared_args --out "${out}/${dataset}_bin_3MB.tsv" --bins 3000000 --remove gaps --filter 300000
