...
commands=(
  ...
  "cns segment ./temp/test_cns_align.tsv --split 1000000 --out ./temp/test_segs_1MB.bed --verbose"
  "cns segment ./temp/test_cns_align.tsv --split 1000000 --out ./temp/test_segs_1MB_gaps.bed --remove gaps --filter 500000 --verbose"
  ...
  "cns segment ./temp/test_cns_align.tsv --merge 100000 --out ./temp/mcs_regions.bed --verbose "
